...
#define STRIP2_CURR_Pin GPIO_PIN_6
#define STRIP2_CURR_GPIO_Port GPIOA
#define STRIP6_CURR_Pin GPIO_PIN_7
#define STRIP6_CURR_GPIO_Port GPIOA
#define STRIP7_CURR_Pin GPIO_PIN_4
#define STRIP7_CURR_GPIO_Port GPIOC
#define STRIP3_CURR_Pin GPIO_PIN_5
#define STRIP3_CURR_GPIO_Port GPIOC
#define STRIP4_CURR_Pin GPIO_PIN_0
#define STRIP4_CURR_GPIO_Port GPIOB
#define STRIP8_CURR_Pin GPIO_PIN_1
