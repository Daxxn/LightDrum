...
uint8_t testLEDStates0[8] = {
  32, 64, 96, 128, 160, 192, 224, 0
};

uint8_t testLEDStates1[8] = {
  64, 96, 128, 160, 192, 224, 0, 32
};

uint8_t testLEDStates2[8] = {
  96, 128, 160, 192, 224, 0, 32, 64
};
...
void loop() {
  ...
  if (count % 4) {
    pwm0.SetStates(testLEDStates0, 8);
    // pwm1.SetStates(testLEDStates1, 8);
    // pwm2.SetStates(testLEDStates2, 8);
  }
  else if (count % 5) {
    pwm0.SetStates(testLEDStates1, 8);
    // pwm1.SetStates(testLEDStates2, 8);
    // pwm2.SetStates(testLEDStates0, 8);
  }
  else {
    pwm0.SetStates(testLEDStates2, 8);
    // pwm1.SetStates(testLEDStates0, 8);
    // pwm2.SetStates(testLEDStates1, 8);
  }
